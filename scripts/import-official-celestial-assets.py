...
ARTIFACT_PATH = ROOT / "test-artifacts/celestial-official-asset-import.json"
SCALE_AUDIT_PATH = ROOT / "test-artifacts/celestial-scale-audit.json"
DISTINCTIVENESS_PATH = ROOT / "test-artifacts/texture-distinctiveness-audit.json"
