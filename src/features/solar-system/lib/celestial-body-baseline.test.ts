...
import baselineJson from "../../../../test-artifacts/celestial-body-baseline.json";

import type { CelestialBaselineArtifact } from "./celestial-body-baseline";

const baseline = baselineJson as unknown as CelestialBaselineArtifact;

describe("structured celestial visual baseline", () => {
  it("is anchored to the exact reference commit", () => {
  ...
  it("classifies every catalogued non-Sun/non-planet visual", () => {
