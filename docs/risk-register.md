...
| 3   | Mobil ve zayıf cihazlarda 3B performansı (FPS, texture belleği)                                                                              | Teknik        | Yüksek — mobil kullanılabilirlik MVP kabul kriteri                                   | Orta-yüksek | Tek High visual contract; device-safe DPR sınırı; staged/lazy asset yükleme; 2K runtime texture tavanı; ölçüme dayalı bütçeler (`06` §8); frame loop disiplini; WebGL fallback | Açık — Faz 3'ten itibaren ölçüm         |
